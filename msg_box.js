...
function compose()
{
        ...
        document.getElementById('formContent').insertAdjacentElement('beforeEnd',compose_holder);
...
{//Parses the XML data that was sent in to retrieve the message for this user 
        ...
        {
                $('formContent').removeChild($('formContent').childNodes[0]);
        }
        ...
        message_holder.style.backgroundColor = '#3B8C8B';
        $('formContent').insertAdjacentElement('beforeEnd',message_holder);
...
{
        var removeElem = $$('div.compose_holder');
        document.getElementById('formContent').removeChild(removeElem[0]);
}
